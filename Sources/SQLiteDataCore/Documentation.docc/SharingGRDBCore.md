...
> Important:  This module is automatically imported when you `import SQLiteData`.
...
but SQLiteData is powered directly by SQLite using [Sharing](#What-is-Sharing),
...
[`@FetchAll`](<doc:SQLiteDataCore/FetchAll>), which are similar to SwiftData's
...
This is all you need to know about Sharing to hit the ground running with SQLiteData, but it only
