...
extension FetchAll {
  ...
  public init<V1: QueryRepresentable, each V2: QueryRepresentable>(
    wrappedValue: [Element] = [],
    _ statement: some StructuredQueriesCore.Statement<(V1, repeat each V2)> & Sendable,
    database: (any DatabaseReader)? = nil
  )
  where
...
@available(iOS 17, macOS 14, tvOS 17, watchOS 10, *)
private struct FetchAllStatementPackRequest<
  each Value: QueryRepresentable,
  Statement: StructuredQueriesCore.Statement<(repeat each Value)> & Sendable
>: StatementKeyRequest {
...
@available(iOS 17, macOS 14, tvOS 17, watchOS 10, *)
private struct FetchOneStatementPackRequest<
  each Value: QueryRepresentable,
  Statement: StructuredQueriesCore.Statement<(repeat each Value)> & Sendable
>: StatementKeyRequest {
  let statement: Statement
