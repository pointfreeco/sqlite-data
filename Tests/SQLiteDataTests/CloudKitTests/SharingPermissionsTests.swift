  ...
  extension BaseCloudKitTests {
    ...
    final class SharingPermissionsTests: BaseCloudKitTests, @unchecked Sendable {
      ...
      /// Delete root shared record (no child records) when user does not have permission.
      @available(iOS 17, macOS 14, tvOS 17, watchOS 10, *)
      @Test func deleteRootSharedRecordNoChildRecords() async throws {
        let externalZone = CKRecordZone(
          zoneID: CKRecordZone.ID(
            zoneName: "external.zone",
            ownerName: "external.owner"
      ...
      /// Delete root shared record (with child records) when user does not have permission.
      @available(iOS 17, macOS 14, tvOS 17, watchOS 10, *)
      @Test func deleteRootSharedRecordWithChildRecords() async throws {
        let externalZone = CKRecordZone(
          zoneID: CKRecordZone.ID(
            zoneName: "external.zone",
            ownerName: "external.owner"
